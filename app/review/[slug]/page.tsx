        ...
        <main className="grid gap-8">
                ...
                {breakdown.map((item) => (
                  <div key={item.rating} className="grid grid-cols-[54px_1fr_42px] items-center gap-3 text-sm">
                    ...
                    <span className="h-3 overflow-hidden rounded-full bg-[#E5E7EB]">
                      <span className="block h-full rounded-full" style={{ width: `${item.percentage}%`, backgroundColor: getRatingColour(item.rating) }} />
                    </span>
          ...
          <section>
            <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <h2 className="text-2xl font-bold text-ink">{company.name} reviews</h2>
