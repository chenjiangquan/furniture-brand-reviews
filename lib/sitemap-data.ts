...
export function getStaticSitemapEntries(): SitemapEntry[] {
  ...
  return [
    ...
    { url: absolute("/reviewer-rules"), lastmod: now, changefreq: "monthly", priority: "0.5" },
    { url: absolute("/privacy-choices"), lastmod: now, changefreq: "monthly", priority: "0.5" },
    { url: absolute("/help-centre"), lastmod: now, changefreq: "monthly", priority: "0.5" },
